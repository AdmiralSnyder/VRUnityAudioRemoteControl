...
public class UnityRemoteControlHub : Hub
{
    ...
    /// <returns></returns>
    public Task AddAnimations(string animations) => Clients.All.SendAsync(nameof(AddAnimations), animations);
    ...
    /// <param name="animations"></param>
    /// <returns></returns>
    public Task GameplayImage(string imgBase64) => Clients.All.SendAsync(nameof(GameplayImage), imgBase64);
}
